...
import Vinyl from '@/assets/vinyl-record-svgrepo-com.svg';
  ...
  return (
    <div className="min-h-screen w-screen bg-[#0a192f] flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="flex justify-center py-4">
        <svg fill="#000000" height="112px" width="112px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
    viewBox="0 0 465 465" xmlSpace="preserve" className="fill-white w-28 animate-spin-slow">
            <g>
        ...
        <h1 className="text-4xl md:text-6xl text-white mb-8 font-semibold">welcome to spinning</h1>
        <StartButton />
      </main>
    </div>
  )
